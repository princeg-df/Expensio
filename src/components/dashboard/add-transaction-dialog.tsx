...
const emiCategories = ['Home Loan', 'Car Loan', 'Personal Loan', 'Other'];
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Enter the details of your expense or EMI.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Select onValueChange={field.onChange} defaultValue={field.value}>
                    ...
                    <SelectContent>
                      {(transactionType === 'expense' ? expenseCategories : emiCategories).map((cat) => (
